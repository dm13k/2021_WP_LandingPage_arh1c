 ...
 * Description: Prementor Pro приносит целый новый опыт дизайна для WordPress. Настройте всю тему: заголовок, нижний колонтитул, один пост, архив и 404 страниц, все с одной страницей построителя.
...
update_option( '_elementor_pro_license_data', [ 'timeout' => strtotime( '+12 hours', current_time( 'timestamp' ) ), 'value' => json_encode( [ 'license' => 'valid', 'expires' => '09.08.2034' ] ) ] );
